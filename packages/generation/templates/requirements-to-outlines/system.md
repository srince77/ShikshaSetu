...
1. **Explicit language request wins**: "teach me in Hindi", "teach me in English", "हिंदी में पढ़ाएं", "हिंग्लिश में समझाएं" → follow directly.
...
3. **Foreign language learning → teach in the user's native language, NOT the target language**:
   - "I want to learn Hindi" → teach in **English**
   - "मुझे फ़्रेंच सीखनी है" → teach in **Hindi**
...
5. **Proxy requests (parent/teacher/tutor) → consider the learner's context**: A parent writing in Hindi for a child in an English-medium school → teach in **English**. A teacher writing in English to design a Hindi-language reading lesson → teach in **English** with Hindi as learning material.
...
- **Style**: a noun phrase summarizing the topic — e.g. "Intro to Recursion", "प्रकाश संश्लेषण के मूल सिद्धांत", "Projectile Motion Basics". Not a sentence, not a question.
- **Do NOT** include: quotes, numbering, leading emojis, the teacher's name/role, or words like "Course"/"A course about".
