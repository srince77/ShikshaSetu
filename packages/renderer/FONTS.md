...
`@shikshasetu/renderer` does **not** embed any font binaries. `fonts.css` only declares
`@font-face` rules whose `src` points at self-hosted woff2 files on object
storage. Serving those faces is a
...
Note: ShikshaSetu's own type scale is English/Devanagari only (Source Serif 4,
Manrope, Hind, JetBrains Mono per the design system); the CJK faces below are
inherited from the upstream font-clearance record and are not referenced by
any ShikshaSetu UI or template, they only matter if imported slide content
requests one of these `font-family` names by name.

| Family (`font-family`) | Script name (English gloss) | License | Redistribution | Copyright / source |
| ---------------------- | ---------------------------- | ------- | :------------: | ------------------ |
| `SourceHanSans`   | Source Han Sans (Si Yuan Hei Ti)     | SIL OFL 1.1            | ✅ | © 2014–2021 Adobe, Reserved Font Name "Source Han Sans" — https://github.com/adobe-fonts/source-han-sans |
| `SourceHanSerif`  | Source Han Serif (Si Yuan Song Ti)     | SIL OFL 1.1            | ✅ | © 2017–2021 Adobe, Reserved Font Name "Source Han Serif" — https://github.com/adobe-fonts/source-han-serif |
| `LXGWWenKai`      | LXGW WenKai (Xia Wu Wen Kai)     | SIL OFL 1.1            | ✅ | © 2021 The LXGW WenKai Project Authors — https://github.com/lxgw/LxgwWenKai |
| `ZhuQueFangSong`  | ZhuQue FangSong (Zhu Que Fang Song)     | SIL OFL 1.1            | ✅ | © 2023 Zhejiang JadeFoci Technology Co. LTD — https://www.jadefoci.com/ |
| `ZcoolHappy`      | ZCOOL Happy (Zhan Ku Kuai Le Ti)   | ZCOOL free-use license (permanent free-use grant for all users, commercial use permitted) | ✅ (conditions) | © ZCOOL, designers retain attribution — [license](./font-licenses/ZcoolHappy-LICENSE.txt) |
| `WenDingPLKaiTi`  | WenDing PL KaiTi (AR PL KaitiM GB) | Arphic Public License (1999) | ✅ | © 1994–1999 Arphic Technology Co., Ltd. — [license](./font-licenses/ARPHIC-PL.txt) |
...
of `AR PL KaitiM GB`** licensed under the Arphic Public License.
...
- `AlibabaPuHuiTi` (Alibaba PuHuiTi) — free for commercial **use**, but its license
