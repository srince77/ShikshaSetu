...
import type { PPTShapeElement, ShapeText } from '@shikshasetu/dsl';
  ...
  const defaultLabelContent = (
    <div
      ...
      style={{
        ...
        // PowerPoint/WPS only mirror geometry and position on a group
        // flipH/flipV, the text glyphs stay upright. The parent element-content
        // already applies flipStyle to mirror the SVG path, so applying the same
        // flipStyle to the text here cancels out: two flips, text stays upright.
        transform: flipStyle,
      }}
    >
      <div
