...
import type { PPTVideoElement } from '@shikshasetu/dsl';
    ...
    >
      ...
      >
        {renderVideo ? (
          ...
          // poster/preview frame. A PPTX video element often has no decodable
          // src in this pipeline but does carry a preview image; rendering
          // <video poster> still shows that frame on the live canvas instead
          // of falling through to the gray play-icon placeholder.
